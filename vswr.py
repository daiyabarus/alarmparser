""" ......................................................................
# Application Name				: vswr.py
# Version						: v1.0.5
# Author 						: me@endang-ismaya.com
# Editor                        : daiyabarus@telco-indonesia.com
# Date Created                  : April 19, 2018
# Update						: May 17, 2020
# Comment						: Python 2.7 library
......................................................................."""
import getopt
import os
import re
    ...
    def do_parser(self):
            ...
            if invxr_logs.endswith('.log'):
                ...
                with open(invxr_log) as f:
                    for line in f:
                        ...
                        m_sumbagut_fdd1 = re.match(r'RRU.*FDD=(\w+)\s+?\(\d+:(\d+):\d+\)$', xline)
                        m_sumbagut_gt5_fdd1 = re.match(r'RRU.*FDD=(\w+)\s+?\(\d,\s?\d,\s?\d,\s?\d,\s?\d,\s?\d+:(\d+):\d+\)$', xline)
                        m_sumbagut_gt5_fdd2 = re.match(r'RRU.*FDD=(\w+)\s+?\(\d,\s?\d,\s?\d,\s?\d,\s?\d:(\d+):\d+\)$',xline)
                        m_sumbagut_gt5_fdd3 = re.match(r'RRU.*FDD=(\w+)\s+?\(\d,\s?\d,\s?\d,\s?\d:(\d+):\d+\)$', xline)
                        m_sumbagut_tdd1 = re.match(r'RRU.*TDD=(\w+)\s+?\(\d+:(\d+):\d+\)$', xline)
                        ...
                        if m_siteid:
                            ...
                            try:
                                ...
                                vswr = '-'
                            fdd = m_sumbagut_fdd1.group(1)
                            cellid = m_sumbagut_fdd1.group(2)
                            print(sitename, fdd, cellid, rf, vswr)
                            if rf == 'A':
                                dict_a[sitename + ";" + fdd + ";" + cellid] = vswr
                            elif rf == 'B':
                            ...
                            try:
                                ...
                                vswr = '-'
                            fdd = m_sumbagut_gt5_fdd1.group(1)
                            cellid = m_sumbagut_gt5_fdd1.group(2)
                            print(sitename, fdd, cellid, rf, vswr)
                            if rf == 'A':
                                dict_a[sitename + ";" + fdd + ";" + cellid] = vswr
                            elif rf == 'B':
                            ...
                            try:
                                ...
                                vswr = '-'
                            fdd = m_sumbagut_gt5_fdd2.group(1)
                            cellid = m_sumbagut_gt5_fdd2.group(2)
                            print(sitename, fdd, cellid, rf, vswr)
                            if rf == 'A':
                                dict_a[sitename + ";" + fdd + ";" + cellid] = vswr
                            elif rf == 'B':
                            ...
                            try:
                                ...
                                vswr = '-'
                            fdd = m_sumbagut_gt5_fdd3.group(1)
                            cellid = m_sumbagut_gt5_fdd3.group(2)
                            print(sitename, fdd, cellid, rf, vswr)
                            if rf == 'A':
                                dict_a[sitename + ";" + fdd + ";" + cellid] = vswr
                            elif rf == 'B':
                            ...
                            try:
                                ...
                                vswr = '-'
                            fdd = m_sumbagut_tdd1.group(1)
                            cellid = m_sumbagut_tdd1.group(2)
                            print(sitename, fdd, cellid, rf, vswr)
                            if rf == 'A':
                                dict_a[sitename + ";" + fdd + ";" + cellid] = vswr
                            elif rf == 'B':
        ...
        with io.open(file_name, 'a', newline='') as fp:
            for k, v in dict_a.items():
                ...
                fp.write(u'' + k + ";" + v + ";" + dict_b.get(k, '-') + ";" + dict_c.get(k, '-') + ";" + dict_d.get(k, '-') + '\n')
